...
<form class="search__adres__form" action="" method="get">
...
<?else:?>
	<input class="search__field" type="text" placeholder="Введите адрес" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" />
    <button class="search__submit">
        <img class="search__icon" src="<?=SITE_TEMPLATE_PATH?>/img/search__icon.png" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
    </button>
<?endif;?>
