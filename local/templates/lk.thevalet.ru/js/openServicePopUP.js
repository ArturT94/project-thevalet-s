...
const userPopup2MenuLinks = document.querySelectorAll('.user__popup__lvl__2__link');
...
if(userPopup2MenuLinks.length > 0) {
    for (let index = 0; index < userPopup2MenuLinks.length; index++) {
        ...
        userPopup2MenuLink.addEventListener("click", function (e) {
            const popupName = userPopup2MenuLink.getAttribute('href').replace('#', '')
            const curentPopup = document.getElementById(popupName);
...
const ClosePopup2UserMenuLink = document.querySelectorAll('.Close__user__popup__lvl__2');
...
const CloseServicePopupLinks = document.querySelectorAll('.service__close-popup');
