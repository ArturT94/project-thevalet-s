    ...
    <svg width = 29 height = 29 version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 50 50" style = "enable-background:new 0 0 50 50; margin-top: 4px;" xml:space="preserve" fill = "none">
<style type="text/css">
	.st-whats-app{fill-rule:evenodd;clip-rule:evenodd; stroke: white; fill: white;}
</style>
<g>
	<g>
		<path class="st-whats-app" d="M25.5,13.3c-6.2,0-11.3,5-11.3,11.2c0,2.2,0.6,4.3,1.9,6.2l-2,5.5l5.8-2c1.7,1,3.6,1.5,5.6,1.5
...
<!--    <img src="--><?//=SITE_TEMPLATE_PATH?><!--/image/whatsapp.svg" alt="">-->