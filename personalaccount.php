  ...
  <div class="conteiner">
    ...
    <div class="global__mobile__block1">
      <div class="menu__profile2">
        ...
        <!--                        <img class="icon__add__address" src="--><? //=SITE_TEMPLATE_PATH
                                                                            ?>
        <!--/img/layout/home__address.svg" alt="home__address">-->
        <!--                    </div>-->
        <!--                    <div class="favourites__profile__name">-->
        <!--                        Добавить рабочий адрес-->
        <!--                        <img class="icon__add__address" src="--><? //=SITE_TEMPLATE_PATH
                                                                            ?>
        <!--/img/layout/icon-briefcase.svg" alt="home__address">-->
        <!--                    </div>-->
        <!--                    <div class="favourites__profile__name">-->
        <!--                        Добавить другой адрес-->
        <!--                        <img class="icon__add__address" src="--><? //=SITE_TEMPLATE_PATH
                                                                            ?>
        <!--/img/layout/+_add.svg" alt="home__address">-->
        <!--                    </div>  -->
